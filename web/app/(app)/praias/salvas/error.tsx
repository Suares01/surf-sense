...
export default function Error({ error, reset }: PageError) {
  useEffect(() => {
    console.error(error);
  }, [error]);
  ...
  return (
    <div className='flex h-full w-full flex-col items-center justify-center'>
      ...
      <div className='flex flex-col items-center justify-center'>
        <H1 className='mt-8'>500</H1>
        <H3 className='mt-2'>Server Error</H3>
        <P className='mt-4'>Opa, algo deu errado em nossos servidores.</P>
        <Button className='mt-4' onClick={resetPage}>
          Recarregar
        </Button>
      </div>
    </div>
